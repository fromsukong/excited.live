...
- Enterprise revenue phase: B2B2C — advisors/institutions pay for engagement, retention, trust. Self-serve revenue ($99/year subscriptions + the Advisor tier, docs/pricing.md Revision 3) already precedes this phase. Every advisor-tier subscriber is a white-label sales lead.
