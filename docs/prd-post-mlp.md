...
- Enterprise revenue phase: B2B2C — advisors/institutions pay for engagement, retention, trust. Self-serve revenue ($99/year subscriptions, docs/pricing.md Revision 3) already precedes this phase. Every repeat seat-pack buyer is a white-label sales lead (seat SKU pending re-decision under Revision 3).
